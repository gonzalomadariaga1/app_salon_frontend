...
<template>
    <nav class="my-5 flex gap-3">
        <RouterLink
            ...
            :class="route.name === 'edit-appointment' ? 'bg-blue-900 text-white'  :  'bg-blue-500 text-white'"
        ...
        <RouterLink
            ...
            class="flex-1 text-center p-3 uppercase font-extrabold hover:bg-blue-600 hover:text-white"
            :class="route.name === 'edit-appointment-details' ? 'bg-blue-900 text-white'  :  'bg-blue-500 text-white'"
